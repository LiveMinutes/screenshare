module.exports = (grunt) ->
    ...
    grunt.initConfig
      ...
      coffee:
          ...
          demoClientEmit:
              files:
                  "<%=dest%>/public/js/demo-client-emit.js": ["../client/Base.coffee", "public/coffee/DemoEmit.coffee"]
          demoClientReceive:
              files:
                  "<%=dest%>/public/js/demo-client-receive.js": ["../client/Base.coffee", "public/coffee/DemoReceive.coffee"]
          demoServer:
            files:
